...
public class PageUtil {
    ...
    public static String genPagination(String targetUrl,long totalNum,int currentPage,int pageSize,String param){
        ...
        if (StringUtil.isNotEmpty(param)){
            ...
            if(currentPage>1){
                pageCode.append("<a href='"+targetUrl+"/"+(currentPage-1)+"' class='layui-laypage-prev'>上一页</a>");
            }else{
                pageCode.append("<a href='javascript:;' class='layui-laypage-prev layui-disabled'>上一页</a>");
            }
            for(int i=currentPage-2;i<=currentPage+2;i++){
            ...
            if(currentPage<totalPage){
                pageCode.append("<a href='"+targetUrl+"/"+(currentPage+1)+"' class='layui-laypage-next'>下一页</a>");
            }else{
                pageCode.append("<a href='javascript:;' class='layui-laypage-next layui-disabled'>下一页</a>");
            }
